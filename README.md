...
All the studies require you to **adjust input and output paths** on your computer. You are required to specify path to repository (.../DTD-donation) correctly in the beginning and end of each script, depending on where you want to store the data. 
